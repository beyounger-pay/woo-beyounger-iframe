console.log('===var_site_id===', plugin_name_ajax_object.var_site_id);
var siteId = plugin_name_ajax_object.var_site_id;
if (!siteId) {
  siteId = 'cee54b02ef4a';
}
...
document.addEventListener("beyounger:token", (event) => {
    localStorage.setItem("device_token", event.detail);
