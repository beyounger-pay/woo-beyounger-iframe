function payInit({tradeId:i,userElement:e,url:t,buttonName:s="payButton"}){const o=axios.create({baseURL:t+"/payment/page/v5",timeout:6e4});const c=(e,t)=>{let s=t||"APGPaymentAesKey";const a=CryptoJS.enc.Utf8.parse(s);const l=CryptoJS.AES.encrypt(JSON.stringify(e),a,{mode:CryptoJS.mode.ECB,padding:CryptoJS.pad.Pkcs7});return l.toString()};let a=document.getElementsByClassName(e)[0];const n=document.documentElement.clientHeight;const j=document.documentElement.clientWidth;let d="";a.style.position="relative";a.innerHTML=`
  ...
  <div class="paycard">
  <div class="payHead">
      <input type="radio" class="payRadio creditCard" name="key" checked>
